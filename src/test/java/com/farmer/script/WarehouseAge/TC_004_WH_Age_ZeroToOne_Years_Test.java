...
public class TC_004_WH_Age_ZeroToOne_Years_Test extends BaseTest{
	...
	@Test
	public void warehouseAgeZerotoOneYear() throws Exception {

		try {

			System.out.println("TC_004_WH_Age_ZeroToOne_Years_Test");
			extentreport= extent.createTest("TC_004_WH_Age_ZeroToOne_Years_Test","Verify Assigned warehouse for the farmer between 0 to 1 year, and 100% allowance is assigned for the direct sale, Allow user to make request");

			FarmerLandingPage farmerLandingpage = new FarmerLandingPage(device_driver);
			farmerLandingpage.navigateToLoginPage();

			String username = getValue("USERNAME22");
			String password = getValue("PASSWORD22");

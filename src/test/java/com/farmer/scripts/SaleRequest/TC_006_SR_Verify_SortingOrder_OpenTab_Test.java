...
public class TC_006_SR_Verify_SortingOrder_OpenTab_Test extends BaseTest{
	...
	public void salesRequest_SortOpenTab() throws Exception {

		System.out.println("TC_006_SR_Verify_SortingOrder_OpenTab_Test");
		try {
			extentreport= extent.createTest("SortBy_OpenTab","Verify Sort By Under Open Tab");

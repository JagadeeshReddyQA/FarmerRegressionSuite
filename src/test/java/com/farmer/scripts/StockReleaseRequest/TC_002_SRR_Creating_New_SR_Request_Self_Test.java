...
public class TC_002_SRR_Creating_New_SR_Request_Self_Test extends BaseTest{
	...
	@Test
	public void stockReleaseRequest_Self() throws Exception {
		try {		
			System.out.println("TC_002_SSR_stockReleaseRequest_Self");
			extentreport= extent.createTest("Stock Release Request_Self","Create New Self Stock Release Request");
			...
			try {//Check If Product Is Avaliable
				if (farmerStockReleaseRequestsPage.Self.isDisplayed()) {
					farmerStockReleaseRequestsPage.Self.click();
					farmerStockReleaseRequestsPage.WareHouse.click();
					Thread.sleep(3000);
					farmerStockReleaseRequestsPage.Select_WareHouse.click();
					Thread.sleep(3000);
					farmerStockReleaseRequestsPage.Product.click();
					Thread.sleep(4000);
					farmerStockReleaseRequestsPage.Select_Product.click();
					requestedQuantity=farmerStockReleaseRequestsPage.Total_Quantity.getText();
					farmerStockReleaseRequestsPage.Requested_Quantity.sendKeys(requestedQuantity);
	...
	private void sr_Request_Details() {
		try {
			//extentreport=extent.createTest("Stock Release Request Details","Verifying Details After Creating Stock Release Request");
			FarmerStockReleaseRequestsPage farmerStockReleaseRequestsPage = new FarmerStockReleaseRequestsPage(device_driver);
